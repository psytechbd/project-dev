...
class Reference(QWidget):
    def __init__(self):
        ...
        self.label1 = QtWidgets.QLabel("Is the pipetrain solvent-cleaned\n and full of air?")
        self.label1.setAlignment(Qt.AlignCenter)
        self.label1.setStyleSheet(
            "QLabel {font-size: %dpx;}" % (27))
        self.label2 = QtWidgets.QLabel("A reference signal needs to be obtained and these\n conditions must be met\n")
        self.label2.setAlignment(Qt.AlignCenter)
        self.label2.setStyleSheet(
            "QLabel {font-size: %dpx;}" % (16))
        self.label2.setWordWrap(True)
        self.start_button = QtWidgets.QPushButton("Yep, get a reference!")
        self.stop_button = QtWidgets.QPushButton("Nope, use old reference")
