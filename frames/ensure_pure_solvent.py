...
class EnsurePureSolvent(QWidget):
    def __init__(self):
        super().__init__()
        ...
        self.label1 = QtWidgets.QLabel("Is the pipetrain running clean\n solvent? (no biomass added)")
        self.label1.setAlignment(Qt.AlignCenter)
        self.label1.setStyleSheet(
            "QLabel {font-size: %dpx;}" % (27))
        self.label2 = QtWidgets.QLabel("Press when ready to start live data\n\n")
        self.label2.setAlignment(Qt.AlignCenter)
        self.label2.setStyleSheet(
            "QLabel {font-size: %dpx;}" % (16))
        self.label2.setWordWrap(True)
        self.start_button = QtWidgets.QPushButton("Yes, pure solvent now!")
        self.stop_button = QtWidgets.QPushButton("No, it’s not totally clean")
